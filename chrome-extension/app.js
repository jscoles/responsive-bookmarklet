...
(function(rb) {
    ...
    var d = document,
        ...
        refreshCss = function(disable){
            ...
            var b = ifrm.querySelector('body');
            if(disable){
                var el = ifrm.getElementById('cssrefresh');
                if(el){
                ...
                var t = ifrm.createTextNode("(function(){var script=document.createElement('script');script.setAttribute('src','http://responsive.victorcoulon.fr/assets/js/cssrefresh.js');script.setAttribute('id','cssrefresh');var head=document.getElementsByTagName('head');head[0].appendChild(script)})()"),
                    s = ifrm.createElement("script");
                b.classList.add('cssrefresh');
                s.appendChild(t);
                ifrm.body.appendChild(s);
            }
        },
    ...
    readyElement('wrapper', function(){
        ...
        iframe = d.querySelector('#wrapper iframe');
        ...
        iframe.addEventListener('load', function(e){
            ...
            d.title = ifrm.title + ' - Responsive test';
            if(history.pushState) {
                try {
                    history.pushState({},  "New Page", ifrm.location);
                }
                catch (e) {}
            }
            if(refreshBtn.classList.contains('active')){
