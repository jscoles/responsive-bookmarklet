        ...
        var d = document,
            ...
            refreshCss = function(disable){
                ...
                if(disable){
                    ...
                    var url = chrome.extension.getURL("refresh.js"),
                        t = ifrm.createTextNode("(function(){var script=document.createElement('script');script.setAttribute('src','"+url+"');script.setAttribute('id','cssrefresh');var head=document.getElementsByTagName('head');head[0].appendChild(script)})()"),
